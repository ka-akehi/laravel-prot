...
) ENGINE=InnoDB AUTO_INCREMENT=59865 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `status_logs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `status_logs_status_index` (`status`),
  KEY `status_logs_account_id_index` (`account_id`),
  KEY `status_logs_status_account_id_index` (`status`,`account_id`),
  CONSTRAINT `status_logs_account_id_foreign` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-09-23  4:57:07
